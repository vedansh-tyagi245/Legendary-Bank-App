...
function AnnualInterest() {
  ...
  const [sipRate, setSipRate] = useState(5); // SIP Interest Rate
  const [lumpsumRate, setLumpsumRate] = useState(5); // Lumpsum Interest Rate
  ...
  const calculateLumpsum = () => {
    ...
    const futureValueLumpsum = lumpsumAmount * Math.pow(1 + r, lumpsumTime);
