                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center ms-3">
                                ...
                                <div class="z-50 hidden my-4 text-base list-none divide-y rounded-sm shadow-sm bg-gray-700 divide-gray-600" id="dropdown-user">
                    ...
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="#" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                                <svg class="shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
