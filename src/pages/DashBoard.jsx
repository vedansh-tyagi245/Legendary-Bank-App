...
import DashBoardMainBodyDemo from '../components/DashBoardMainBodyDemo';
...
function DashBoard() {
    ...
    return (
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-700">
         <li>
            <a href="#" class="flex items-center p-2 transition duration-75 rounded-lg bg-gray-100 hover:bg-gray-700 text-white group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 transition duration-75 rounded-lg hover:bg-gray-700 text-white group">
               <svg class="shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
